...
void LanguageManager::generateLangList()
{
	...
	m_langTable.append(LangDef("prs",      "",         "Afghan Persian/Dari",                 QObject::tr("Afghan Persian/Dari")));
	...
	m_langTable.append(LangDef("ang",      "",         "Anglo-Saxon",                         QObject::tr("Old English (ca. 450-1100)")));
	...
	m_langTable.append(LangDef("frp",      "",         "Arpitan/Francoprovençal",             QObject::tr("Arpitan/Francoprovençal")));
	m_langTable.append(LangDef("rup",      "",         "Aromanian/Arumanian/Macedo-Romanian", QObject::tr("Aromanian/Arumanian/Macedo-Romanian")));
	m_langTable.append(LangDef("as",       "",         "Assamese",                            QObject::tr("Assamese")));
	m_langTable.append(LangDef("ast",      "",         "Asturian/Asturleonese/Bable/Leonese", QObject::tr("Asturian/Asturleonese/Bable/Leonese")));
	...
	m_langTable.append(LangDef("azj",      "",         "North Azerbaijani",                   QObject::tr("North Azerbaijani")));
	m_langTable.append(LangDef("azb",      "",         "South Azerbaijani",                   QObject::tr("South Azerbaijani")));
	...
	m_langTable.append(LangDef("bci",      "",         "Baulé",                               QObject::tr("Baulé")));
	...
	m_langTable.append(LangDef("be",       "",         "Belarussian",                         QObject::tr("Belarussian")));
	...
	m_langTable.append(LangDef("eot",      "",         "Beti (Côte d'Ivoire)",                QObject::tr("Beti (Côte d'Ivoire)")));
	...
	m_langTable.append(LangDef("bcl",      "",         "Central Bikol",                       QObject::tr("Central Bikol")));
	...
	m_langTable.append(LangDef("km",       "",         "Central Khmer",                       QObject::tr("Central Khmer")));
	m_langTable.append(LangDef("ckb",      "",         "Central Kurdish (Sorani)",            QObject::tr("Central Kurdish (Sorani)")));
	...
	m_langTable.append(LangDef("ny",       "",         "Chewa/Chichwa/Nyanja",                QObject::tr("Chewa/Chichwa/Nyanja")));
	...
	m_langTable.append(LangDef("zh",       "",         "Choctaw",                             QObject::tr("Choctaw")));
	...
	m_langTable.append(LangDef("crm",      "",         "Cree [Moose] ",                       QObject::tr("Moose Cree")));
	m_langTable.append(LangDef("crj",      "",         "Cree [Southern] East ",               QObject::tr("[Southern] East Cree")));
	m_langTable.append(LangDef("crl",      "",         "Cree [Northern] East ",               QObject::tr("[Northern] East Cree")));
	...
	m_langTable.append(LangDef("ada",      "cs_CZ",    "Dangme",                              QObject::tr("Dangme")));
	m_langTable.append(LangDef("da",       "da_DK",    "Danish",                              QObject::tr("Danish")));
	m_langTable.append(LangDef("dar",      "",         "Dargwa",                              QObject::tr("Dargwa")));
	m_langTable.append(LangDef("dv",       "",         "Dhivehi/Divehi/Maldivian",            QObject::tr("Dhivehi/Divehi/Maldivian")));
	...
	m_langTable.append(LangDef("doi",      "",         "Dogri [macrolanguage]",               QObject::tr("Dogri [macrolanguage]")));
	m_langTable.append(LangDef("nl",       "nl_NL",    "Dutch",                               QObject::tr("Dutch")));
	m_langTable.append(LangDef("dz",       "",         "Dzongkha",                            QObject::tr("Dzongkha")));
	m_langTable.append(LangDef("emk",      "",         "Eastern Maninkakan",                  QObject::tr("Eastern Maninkakan")));
	m_langTable.append(LangDef("igb",      "",         "Ebira",                               QObject::tr("Ebira")));
	m_langTable.append(LangDef("efi",      "",         "Efik",                                QObject::tr("English (Efik)")));
	m_langTable.append(LangDef("guz",      "",         "Ekegusii/Gusii",                      QObject::tr("Ekegusii/Gusii")));
	...
	m_langTable.append(LangDef("ki",       "",         "Gikuyu/Kikuyu",                       QObject::tr("Gikuyu/Kikuyu")));
	...
	m_langTable.append(LangDef("ht",       "",         "Haitian/Haitian",                     QObject::tr("Haitian/Haitian")));
	...
	m_langTable.append(LangDef("ie",       "",         "Interlingue/Occidental",              QObject::tr("Interlingue/Occidental")));
	m_langTable.append(LangDef("iu",       "",         "Inuktitut",                           QObject::tr("Inuktitut")));
	m_langTable.append(LangDef("ik",       "",         "Inupiaq",                             QObject::tr("Inupiaq")));
	m_langTable.append(LangDef("pes",      "",         "Iranian Persian",                     QObject::tr("Iranian Persian")));
	...
	m_langTable.append(LangDef("jam",      "",         "Jamaican Creole English",             QObject::tr("Japanese")));
	...
	m_langTable.append(LangDef("quc",      "",         "K'iche'/Quiché",                      QObject::tr("K'iche'/Quiché")));
	...
	m_langTable.append(LangDef("pam",      "",         "Kapampangan/Pampanga",                QObject::tr("Kapampangan/Pampanga")));
	...
	m_langTable.append(LangDef("ky",       "",         "Kirghiz/Kyrgyz",                      QObject::tr("Kirghiz/Kyrgyz")));
	m_langTable.append(LangDef("swh",      "",         "Kiswahili/Swahili",                   QObject::tr("Kiswahili/Swahili")));
	...
	m_langTable.append(LangDef("ksh",      "",         "Kölsch",                              QObject::tr("Kölsch")));
	...
	m_langTable.append(LangDef("kmw",      "",         "Komo (Democratic Republic of Congo)", QObject::tr("Komo (Democratic Republic of Congo)")));
	...
	m_langTable.append(LangDef("knn",      "",         "Konkani",                             QObject::tr("Konkani")));
	m_langTable.append(LangDef("kok",      "",         "Konkani [macrolanguage]",             QObject::tr("Konkani [macrolanguage]")));
	...
	m_langTable.append(LangDef("kj",       "",         "Kuanyama/Kwanyama",                   QObject::tr("Kuanyama/Kwanyama")));
	...
	m_langTable.append(LangDef("li",       "",         "Limburgan/Limburger/Limburgish",      QObject::tr("Limburgan/Limburger/Limburgish")));
	...
	m_langTable.append(LangDef("nds",      "",         "Low German/Low Saxon",                QObject::tr("Low German/Low Saxon")));
	...
	m_langTable.append(LangDef("khb",      "",         "Lü",                                  QObject::tr("Lü")));
	...
	m_langTable.append(LangDef("luy",      "",         "Luyia/Oluluyia",                      QObject::tr("Luyia/Oluluyia")));
	...
	m_langTable.append(LangDef("ml",       "",         "Malayalam",                           QObject::tr("Malayalam")));
	...
	m_langTable.append(LangDef("man",      "",         "Manding/Mandingo",                    QObject::tr("Manding/Mandingo")));
	...
	m_langTable.append(LangDef("mdr",      "",         "Manipuri",                            QObject::tr("Manipuri")));
	...
	m_langTable.append(LangDef("el",       "",         "Modern Greek (1453-)",                QObject::tr("Modern Greek (1453-)")));
	...
	m_langTable.append(LangDef("ary",      "",         "Moroccan Arabic",                     QObject::tr("Mongolian")));
	...
	m_langTable.append(LangDef("lrc",      "",         "Northern Luri",                       QObject::tr("Northern Luri")));
	...
	m_langTable.append(LangDef("blk",      "",         "Pa'O/Pa'o Karen",                     QObject::tr("Pa'O/Pa'o Karen")));
	...
	m_langTable.append(LangDef("ps",       "",         "Pashto/Pushto",                       QObject::tr("Pashto/Pushto")));
	...
	m_langTable.append(LangDef("luz",      "",         "Southern Luri",                       QObject::tr("Southern Luri")));
	...
	m_langTable.append(LangDef("ekk",      "",         "Standard Estonian",                   QObject::tr("Standard Estonian")));
	...
	m_langTable.append(LangDef("tyz",      "",         "Tày",                                 QObject::tr("Tày")));
	...
	m_langTable.append(LangDef("tdd",      "",         "Tai Nüa",                             QObject::tr("Tai Nüa")));
	...
	m_langTable.append(LangDef("tiv",      "",         "Tonga (Tonga Islands)",               QObject::tr("Tonga (Tonga Islands)")));
	...
	m_langTable.append(LangDef("vo",       "",         "Volapük",                             QObject::tr("Volapük")));
	m_langTable.append(LangDef("vro",      "",         "Võro",                                QObject::tr("Võro")));
	...
	m_langTable.append(LangDef("fy",       "",         "Western Frisian",                     QObject::tr("Western Frisian")));
	m_langTable.append(LangDef("kyu",      "",         "Western Kayah",                       QObject::tr("Western Kayah")));
	m_langTable.append(LangDef("mlq",      "",         "Western Maninkakan",                  QObject::tr("Western Maninkakan")));
